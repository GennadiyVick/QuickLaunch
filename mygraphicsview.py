...
from PyQt5.QtCore import Qt, QTimer, QDir, QFile, QSize, QPointF, QSettings, QUrl, \
    QTextStream, QProcess, QMimeData
...
#        files = []
 ...
 #       files.append(QUrl.fromLocalFile("/home/genius/yandexdisk/python/GuiPy/gui.ui"))
  ...
  #      drag.exec_(QtCore.Qt.CopyAction) 
    ...
    def stylebtn(self):
        s = self.prnt.ui.ltitle.styleSheet()
        if len(s) < 6:
            s = "#ffffff"
        else:
            s = s[7:]
        c = QColor(s)
        se = StyleEditWindow(self.prnt,c)
